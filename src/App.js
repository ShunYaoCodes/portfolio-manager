  ...
  render() {
    return (
      <Router>
        <Grid centered>
          <Grid.Row>
            <Grid.Column computer={4} mobile={15} textAlign='left' style={{marginTop: '10px'}}>
              <NavLink to='/' exact><h1>Portfolio Manager and Hedger</h1></NavLink>
            </Grid.Column>
            <Grid.Column computer={6} mobile={15} textAlign='center' className='search-bar'>
              <SearchBar />
            </Grid.Column>
            <Grid.Column computer={4} mobile={15} textAlign='right' style={{marginTop: '10px'}} className='user-actions'>
              {
                this.loggedIn ?
                  <>
            ...
            <Grid.Column style={{marginTop: '5px'}} computer={14} mobile={15}>
              <NavBar />
            </Grid.Column>
          </Grid.Row>
